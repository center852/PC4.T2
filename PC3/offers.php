     ...
     <section>
          <div class="container">
               <div class="text-center">
                    ...
                    <p class="lead">A TU MANERA, A TU GUSTO.</p>
               </div>
          </div>
     </section>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="courses-thumb courses-thumb-secondary">
                              ...
                              <div class="courses-detail">
                                   ...
                                   <p class="lead"><small>desde </small> <strong>$113</strong> <small>por semana</small></p>
                              </div>
                         </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="courses-thumb courses-thumb-secondary">
                              ...
                              <div class="courses-detail">
                                   ...
                                   <p class="lead"><small>desde</small> <strong>$87</strong> <small>por semana</small></p>
                              </div>
                         </div>
                    </div>
               </div>
